...
{{--                                    <li class="nav-item"><a class="nav-link" id="contact-top-tab" data-bs-toggle="tab" href="#top-contact" role="tab" aria-controls="top-contact" aria-selected="false"><i data-feather="check-circle"></i>Done</a></li>--}}
                            ...
                            <div class="col-md-6 p-0">
                                <div class="form-group mb-0 me-0"></div><a class="btn btn-primary" href="{{route('systems.create')}}"> <i data-feather="plus-square"> </i>Create New System</a>
                            </div>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="tab-pane fade show active" id="top-home" role="tabpanel" aria-labelledby="top-home-tab">
                                    <div class="row">
                                        ...
                                        <div class="col-xxl-4 col-lg-6">
                                            ...
                                            <div class="project-box"> <a href="{{route('systems.edit' , $system->id)}}" class="badge badge-primary">Edit</a>
                                                <h6> {{convertLanguageToEnglish($system->title) ?? ''}}  <br> {{convertLanguageToArabic($system->title) ?? ''}}  </h6>
                                                <div class="media"><img class="img-20 me-2 rounded-circle" src="{{asset('public/images/systems/' . $system->image)}}" alt="" data-original-title="" title="">
                                                ...
                                                <p>
                                                    {{convertLanguageToEnglish($system->description)  }}
                                                    {{convertLanguageToArabic($system->description)  }}
                                                </p>
                                                 <div class="customers">
                                                 </div>
                                             </div>
