                          ...
                          <div class="row">
                              <div class="col-sm-12">
                                  <div class="card">
                                      ...
                                      <div class="card-body">
                                          <form action="{{route('about-us.store')}}" method="post" class="theme-form mega-form" enctype="multipart/form-data">
                                          @csrf
                                              ...
                                              <div class="mb-3">
                                                  ...
                                                  <textarea   rows="5" class="form-control" name="more_description_one_ar" > </textarea>
                                              </div>
                                              <div class="mb-3">
                                                  <label class="col-form-label">    more_description_one  english  </label>
                                                  <textarea   rows="5" class="form-control" name="more_description_one_en"  > </textarea>
                                              </div>
                                              ...
                                              <div class="mb-3">
                                                  ...
                                                  <input class="form-control" name="title_two_ar" type="text" placeholder=" title_two   arabic">
                                              </div>
                                              <div class="mb-3">
                                                  <label class="col-form-label">    title_two  english  </label>
                                                  <input class="form-control" name="title_two_en" type="text" placeholder=" title_two   english">
                                              </div>


                                              <div class="mb-3">
                                                  <label class="col-form-label">    description_two  arabic  </label>
                                                  <textarea   rows="5" class="form-control" name="description_two_ar" > </textarea>
                                              </div>
                                              <div class="mb-3">
                                                  <label class="col-form-label">    description_two  english  </label>
                                                  <textarea   rows="5" class="form-control" name="description_two_en"  > </textarea>
                                              </div>
                                              ...
                                              <div class="mb-3">
                                                  ...
                                                  <input class="form-control" name="right_bottom_title_ar" type="text" placeholder=" right_bottom_title   arabic">
                                              </div>
                                              <div class="mb-3">
                                                  <label class="col-form-label">    right_bottom_title  english  </label>
                                                  <input class="form-control" name="right_bottom_title_en" type="text" placeholder=" right_bottom_title   english">
                                              </div>
...
{{--                                              --}}
                                              ...
                                              <div class="mb-3">
                                                  ...
                                                  <input class="form-control" name="left_bottom_title_ar" type="text" placeholder=" left_bottom_title   arabic">
                                              </div>
                                              <div class="mb-3">
                                                  <label class="col-form-label">    left_bottom_title  english  </label>
                                                  <input class="form-control" name="left_bottom_title_en" type="text" placeholder=" left_bottom_title   english">
                                              </div>
                                              ...
                                              <div class="mb-3">
                                                  ...
                                                  <input class="form-control" name="left_bottom_desc_ar" type="text" placeholder=" left_bottom_desc   arabic">
                                              </div>
                                              <div class="mb-3">
                                                  <label class="col-form-label">    left_bottom_desc  english  </label>
                                                  <input class="form-control" name="left_bottom_desc_en" type="text" placeholder=" left_bottom_desc   english">
                                              </div>
